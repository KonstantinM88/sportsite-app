    ...
    <div className="flex flex-col-reverse md:flex-row items-center md:items-start gap-8">
      ...
      <div className="flex-1 space-y-4 text-gray-800">
        ...
        <p className="text-lg leading-relaxed">
          Введение в плавание. Изучите дыхание, стили плавания и технику гребка.
        </p>
        <ul className="list-disc pl-6 text-base leading-relaxed">
          <li>Дыхание</li>
          <li>Стили плавания</li>
          <li>Техника гребка</li>
          <li>Безопасность на воде</li>
        </ul>
        <p className="text-base">Курс подходит для начинающих и опытных пловцов.</p>
